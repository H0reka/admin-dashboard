  ...
  const CategoryTable = (props) => {
    ...
    const columns = [
      columnHelper.accessor("imageUrl", {
        ...
        cell: (info) => (
          <img
            src={info.getValue()?info.getValue():"https://via.placeholder.com/150"}
            alt="..."
      ...
      columnHelper.accessor("", {
        cell: ({row})=>(<Link to='/addcategory' state={{data: row.original}}><FaEdit className="cursor-pointer" size={24}/></Link>),
        header: "Action",
      }),
    ];

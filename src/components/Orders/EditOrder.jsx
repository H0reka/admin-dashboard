  ...
  return (
    <div className="ml-[4.2rem] lg:ml-[10.3rem] overflow-y-scroll no-scrollbar h-[97vh]">
      ...
      <div className="grid grid-cols-12 p-10 gap-3">
        ...
        <div className="bg-white/30 backdrop-blur-3xl text-black col-span-6  p-3 rounded-lg flex flex-col gap-2 h-fit">
        ...
        <div className="bg-white/30 backdrop-blur-3xl text-black rounded-lg p-3 col-span-6 flex flex-col gap-2 h-fit">
        ...
        <div className=" text-white col-span-6 p-3 flex flex-col gap-2">
          <div>
        ...
        <div className=" text-white col-span-6 p-3 rounded-lg flex flex-col gap-2 items-end">
          <h1>
